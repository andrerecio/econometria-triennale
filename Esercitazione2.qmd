...
Un anno in più di istruzione è associato ad un aumento, in media, del salario orario di 0.64\$ mantenendo costante gli anni di esperienza nel mercato del lavoro e gli anni con lo stesso datore di lavoro.
...
- Seconda regressione: A parità $hsGPA$ e di punteggio $ACT$, il possesso di un PC è associato, in media, a un aumento di circa 0.16 punti in $colGPA$.

- Terza regressione:  A parità $hsGPA$, punteggio $ACT$ e istruzione dei genitori ($mothcoll$ e $fathcoll$), il possesso di un PC è associato, in media, a un aumento di circa 0.15 punti in $colGPA$.
...
- In media, un uomo sposato, guadagna 1.822 dollari in più rispetto ad un uomo single a parità di istruzione, esperienza e anni con l'attuale datore di lavoro ($tenure$).

- In media, una donna sposata, guadagna 0.882 dollari in meno rispetto ad un uomo single a parità di istruzione, esperienza e $tenure$.

- In media, una donna single, guadagna 0.309 dollari in meno rispetto ad un uomo single a parità di istruzione, esperienza e $tenure$.
