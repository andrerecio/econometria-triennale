...
| :---------- | :---------------------------------------------------------------------------------------- |
| $abuse$     | Variabile dipendente (1=Abuse di Alcol, 0=Non abusa negato).                                  |
| $employ$    | Variabile dummy (1=Occupato, 0=Non occupato).                              |
...
- Secondo il modello Logit, abusare di alcol riduce la probabilità di essere occupato di 1.9 p.p.
- Secondo il modello Probit, abusare di alcol riduce la probabilità di essere occupato di 2.1 p.p.
...
- Un anno in più di istruzione auementa la probabilità di essere occupati 1.5 punti percenutali
