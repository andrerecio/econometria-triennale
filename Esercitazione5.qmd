...
Quando $pareduccenter = 0$, abbiamo che $pareduc$ è uguale alla sua media, l’effetto marginale corrisponde a $\beta_3$, ossia l’effetto marginale medio. Quando $pareduccenter = 2$, cioè due unità sopra la media, l’effetto marginale diventa: $\beta_3 +  \beta_5 \cdot 2$
