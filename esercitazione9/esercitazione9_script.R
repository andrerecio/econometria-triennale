...
modelsummary(
  list("OLS" = ols_labsup, "IV" = iv_labsup),
  gof_omit = "IC|Adj|RMSE"
)


# --- Strumento alternativo: multi2nd (parto gemellare al secondo) ---
...
# --- Sovraidentificazione: entrambi gli strumenti ---
...
# Test di rilevanza congiunto
summary(iv_labsup_twins_over, stage = 1)
fitstat(iv_labsup_twins_over, type = "ivwald")

# Test J di sovraidentificazione (procedura manuale + verifica fitstat)
# m = 2, l = 1 -> sotto H0 vale J ~ chi2(1)
