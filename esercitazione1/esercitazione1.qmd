...
Assumendo omoschedasticità $Var(u_i|educ_i)= \sigma^2$  è equivalente, in popolazione, ad assumere $Var(wage_i|educ_i) = \sigma^2$.
...
Il coefficiente $\beta_1$ riflette quindi una differenza "grezza" nelle retribuzioni, che combina molteplici fattori oltre all'effetto del genere (è a tutti gli effetti una differenza tra medie di $wage$ tra i due gruppi).
