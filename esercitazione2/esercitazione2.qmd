...
Nella precedente [Esercitazione](esercitazione1/esercitazione1.html), abbiamo stimato il seguente modello di regressione semplice:
...
modelsummary(list("Wage 3" = reg_wage2, "Wage 4" = reg_wage3), 
             gof_omit = "AIC|BIC|RMSE", 
             output = "tinytable")
```

**Interpretazione**: Nell’interpretazione dei coefficienti consideriamo l’effetto di una variabile tenendo costanti tutte le altre.


Siamo ancora interessati all'effetto di $educ$ su $wage$, tenendo fissi gli altri fattori.


Un anno in più di istruzione è associato ad un aumento, in media, del salario orario di 0.64 dollari tenendo costante gli anni di esperienza nel mercato del lavoro. Chi ha più anni di istruzione tende ad entrare nel mercato del lavoro più tardi, quindi — a parità di età — ha meno esperienza lavorativa.
...
**Il terzo modello**: Un anno in più di istruzione è associato ad un aumento, in media, del salario orario di 0.59 dollari mantenendo costante gli anni di esperienza nel mercato del lavoro e gli anni con lo stesso datore di lavoro.
...
**Wage orario**: Un anno in più di istruzione è associato, in media, a un aumento del salario orario 0.572 dollari in più, a parità di genere, esperienza e $tenure$


**Wage mensile**: Un anno in più di istruzione è associato, in media, a un aumento del salario mensile di 80 dollari in più, a parità di genere, esperienza e $tenure$


E se $educ$ fosse misurato in mesi di istruzione? 

In [Esercitazione 1](https://andrerecio.github.io/econometria-triennale/Esercitazione1.html) abbiamo visto che nel modello di regressione, esprimendo $educ$ in mesi moltiplicando per 12, l'intercetta non cambiava e il coefficiente associato a $educ$ era diviso 12.


Il coefficente associato ad $educ montlhy$ sarà pari a 0.048 \$ ($\frac{0.572}{12}$). Un mese in più di istruzione è associato, in media, a un aumento del salario orario 0.048 dollari in più, a parità di genere, esperienza e $tenure$. Il resto dei coefficienti, inclusa l'intercetta e la dummy, rimangono invariati. 
