...
Imparare a programmare è molto importante, non solo per l'econometria ma anche per il lavoro e la ricerca in generale:
...
- Aprite un nuovo script R (`File > New File > R Script`)
...
- Questo è un problema di **endogeneità** 
